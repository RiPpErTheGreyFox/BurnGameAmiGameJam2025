...
ENEMYDAMAGEDSAMPLE:
    INCBIN      "assets/sounds/EnemyDamaged.sb"
ENEMYDAMAGEDSAMPLE_LEN=*-ENEMYDAMAGEDSAMPLE

ENEMYDEATHSAMPLE:
    INCBIN      "assets/sounds/EnemyDeath.sb"
ENEMYDEATHSAMPLE_LEN=*-ENEMYDEATHSAMPLE

ENEMYSPAWNSAMPLE:
    INCBIN      "assets/sounds/EnemySpawn.sb"
ENEMYSPAWNSAMPLE_LEN=*-ENEMYSPAWNSAMPLE

PLAYERDAMAGEDSAMPLE:
    INCBIN      "assets/sounds/PlayerDamaged.sb"
PLAYERDAMAGEDSAMPLE_LEN=*-PLAYERDAMAGEDSAMPLE

PLAYERDEATHSAMPLE:
    INCBIN      "assets/sounds/PlayerDeath.sb"
PLAYERDEATHSAMPLE_LEN=*-PLAYERDEATHSAMPLE

PLAYERJUMPSAMPLE:
    INCBIN      "assets/sounds/PlayerJump.sb"
PLAYERJUMPSAMPLE_LEN=*-PLAYERJUMPSAMPLE

PLAYERLANDINGSAMPLE:
    INCBIN      "assets/sounds/PlayerLanding.sb"
PLAYERLANDINGSAMPLE_LEN=*-PLAYERLANDINGSAMPLE

PLAYERSPAWNSAMPLE:
    INCBIN      "assets/sounds/PlayerSpawn.sb"
PLAYERSPAWNSAMPLE_LEN=*-PLAYERSPAWNSAMPLE
